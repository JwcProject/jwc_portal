            ...
            $.fn.kinMaxShow = function(user_options){
                ...
                var default_options = {
                    ...
                    button:{
                        ...
                        normal:{width:'10px',height:'10px',lineHeight:'14px',right:'10px',bottom:'10px',fontSize:'10px',background:"#8dc93a",border:"1px solid #ffffff",color:"#666666",textAlign:'center',marginRight:'8px',fontFamily:"Verdana",float:'left'},
                        //当前 按钮样式
